...
type snapActionResult struct {
	...
	// UpdateActionID correlates a refresh result with a backend update action
	// for transparent-update event reporting (L-IoT). Only present for snap
	// binary refreshes initiated by a backend update action.
