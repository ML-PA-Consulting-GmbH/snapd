...
// buildInfoHash returns a hash of buildInfoPath's contents, or an empty
// string if the file does not exist on this system.
func buildInfoHash() (string, error) {
	data, err := os.ReadFile(filepath.Join(dirs.GlobalRootDir, buildInfoPath))
	if err != nil {
